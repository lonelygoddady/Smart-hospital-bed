...
void* Synchronize_data(void *arg)
{
	...
	file = fopen("./output/client_data_value.csv","wb");
	if (file == NULL)
...
int main(int argc, char **argv)
{
	...
	while(1)
	{
		printf("Please specify which function to perform:\n");
		...
		switch(choice)
		{
			...
			case '2':
		       	//put machine learning traning program here
			break;

			case '3':
			//put real time detection here
			break;
